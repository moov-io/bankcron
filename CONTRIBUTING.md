...
```
$ git clone git@github.com:moov-io/bankcron.git
```

Then, add your (or another user's) fork.

```
$ cd $GOPATH/src/github.com/moov-io/bankcron

$ git remote add $user git@github.com:$user/bankcron.git
...
Our Build pipeline utilizes Github Actions to enforce many tools that you should add to your editor before issuing a pull request. Learn more about these tools on our [Go Report card](https://goreportcard.com/report/github.com/moov-io/bankcron)
